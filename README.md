...
- AI Workspace (3.7.4): Manage AI config files, opt-in `.ai` Git, Semver `.ai/VERSION`, and custom IDEA Terminal commands including Silent Terminal (AI 工作空间：管理 AI 配置、可选 `.ai` Git、Semver 版本和自定义 Terminal/静默终端命令)
